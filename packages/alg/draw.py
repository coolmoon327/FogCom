...
class ResultCurve:
    ...
    def save_plot(self, filename):
        ...
        plt.plot(self.time_points, [self.greedy for _ in range(self.steps)], color='green', linewidth=3, label="Greedy Select")
        plt.plot(self.time_points, [self.all for _ in range(self.steps)], color='orange', linewidth=3, label="All Candidates")
        # plt.plot(self.time_points, [self.random_action for _ in range(self.steps)], label="Random Action")
        plt.plot(self.time_points, [self.random_select for _ in range(self.steps)], color='pink', linewidth=3, label="Random Select")
        plt.plot(self.time_points, self.ppo_results, color='blue', linewidth=2, label="PPO Select")
